...
<nav class="sticky top-0 z-30 w-full py-2 pb-4 -mb-8 flex flex-col items-center drag-region" style="border-bottom: 1px solid rgb(173, 175, 179);">
	<div class="flex items-center w-full pl-1.5 pr-1">
		...
		<div class=" flex max-w-full w-full mx-auto px-1.5 md:px-2 pt-0.5 bg-transparent">
			<div class="flex items-center w-full max-w-full">
				...
				<div
					class="flex-none overflow-hidden max-w-full py-0.5
			{$showSidebar ? 'ml-1' : ''}
			"
				>
